...
class UniNaVid_Agent():
    def __init__(self, model_path = "models/uninavid"):
        ...
        self.prompt_template = "Imagine you are a robot programmed for navigation tasks. You have been given a video of historical observations and an image of the current observation <image>. Your assigned tasks is: '{}'. Analyze this sereis of images to determine your next four actions. The predicted action should be one of the following: forward, left, right or stop."
